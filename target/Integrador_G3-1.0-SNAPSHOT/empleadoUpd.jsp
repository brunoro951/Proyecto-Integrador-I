...
<html>
    ...
    <body>
        ...
        <div style="margin: auto;"  class="letra">Actualizar Empleado</div>

        <div class="d-flex">
            <div class="col-sm-6">  
                <form action="Empleado" method="post" style="margin: auto; display: table"> 
                    <input type="hidden" name="accion" value="UPD"/>            
                    <input type="hidden" name="txtId_empleado" value="${empleado.id}"/>
            ...
            <div class="col-sm-6">
                <img class="imagen rounded "src="IMG/empleados.jpg" alt="alt"/> 
            </div>  
        </div>
