...
public class HistorialServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String result = null;
        String target = "historialSel.jsp";
        HistorialValidator validator = new HistorialValidator(request);
        ...
        switch (accion) {
            case "SEL":
                ...
                break;
            case "INS":
                result = validator.ventaInsUpd(false);
                target = result == null ? "historial.jsp" : "historialIns.jsp";
                break;
            case "DEL":
                result= validator.ventadetalleDel();
                result = validator.ventaDel();
